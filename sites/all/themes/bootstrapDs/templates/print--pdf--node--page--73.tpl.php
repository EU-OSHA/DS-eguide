        ...
        if (isset($checksWC[$cont])){
          ...
          print("<div class='check-question'>");//Div for the whole question
            ...
            if ($respchecksWC[$cont]['resp_id'] =='N/A'){
                print "<div class='q-answers'><span class='answer-title'>". t("Your answer"). ": " .  t('N/A') ."</span></div>";
            }
            if ($respchecksWC[$cont]['resp_id'] =='Skipped'){
                print "<div class='q-answers'><span class='answer-title'>". t("Your answer"). ": " . t("Do not know / Reply later") ."</span></div>";
